...
If you do not want to or need to run the entire sets included in `catch22_all` you can also access the individual feature calculations as their unique function names, for example `IN_AutoMutualInfoStats_40_gaussian_fmmi`.
