...
efficient. Computation time in milliseconds for a range of
cumulative-sum Gaussian noise time series is presented below.
...
To cite package 'Rcatch22' in publications use:
  ...
  Time-series CHaracteristics. R package version 0.1.4.
